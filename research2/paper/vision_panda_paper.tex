...
\begin{figure*}[t]
\centering
\includegraphics[width=0.94\linewidth]{../analysis/dataset_slides/01_axis_diversity_overview.png}
\caption{Slide-matched visual overview of the four controlled diversity axes. Fixed or narrow conditions appear alongside broader color, spatial, camera, and lighting variation, while the robot, expert, observation format, and action interface remain fixed.}
